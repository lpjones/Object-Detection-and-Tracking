...
outputs = imgs_to_network(imgs_blob, yolo_layers, network)

output_path = './out_images/'

# Match name to output label number

try:
    os.mkdir(output_path)
except:
    pass
# Output images with boxes as files in out_images
for i, im in enumerate(imgs_cv2):
    img = draw_image(im, outputs[i], labels)
